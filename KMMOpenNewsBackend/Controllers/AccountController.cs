...
using KMMOpenNewsBackend.Providers;
...
namespace KMMOpenNewsBackend.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        // GET api/Account/AllUsersData
        [Route("AllUsersData")]
        [OverrideAuthentication]
        [AllowAnonymous]
        public async Task<IEnumerable<ApplicationUser>> GetUsersData() {
            try
            {
                ...
                //{
                //    var detail = new UserInfoViewModel();
                //    detail.Email = user.Email;
                //    detail.NewsPosts = user.NewsPosts;
                //    detail.UserComments = user.UserComments;
